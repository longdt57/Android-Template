 ...
 * from [BaseComposeFragment] [BaseComposeActivity], with the [BaseViewModel]
 *
 * These methods are set to go well with the Lifecycle of the [BaseComposeFragment] [BaseComposeActivity],
 ...
 */
interface BaseComposeCallbacks {
    ...
    @Composable
    fun LoadingScreen(isLoading: IsLoading) {
